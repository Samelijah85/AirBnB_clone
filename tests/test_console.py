#!/usr/bin/python3
"""Implements unittests for console.py.
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Testing the exit method of the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Testing the create method of the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Testing the show method of the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Testing the destroy method of the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Testing all method of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Testing the update method of the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Testing the count method of HBNB comand interpreter."""
